...
echo The %date% at %time% nikusOS crashed because the error 0x002 is occuring. >>crashreport.txt
...
echo Crash Report
echo.
echo Error 0x002: nikusOS can't found external command inserbmp.exe.
